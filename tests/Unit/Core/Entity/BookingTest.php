...
it('devo sair no horário exato da reserva', function () {
    $property = new Property(
        id: '1',
        title: 'Casa de praia',
        description: 'Casa de praia com 3 quartos',
    ...
    $booking->checkout(new DateTime('2020-01-10 14:00:59'));

    expect($booking)
        ->isCompleted()->toBeTrue()
        ->getTotalPrice()->toBe(810.0);
});

it('o checkout foi realizado um minuto depois do limite estabelecido', function () {
    $property = new Property(
        id: '1',
        title: 'Casa de praia',
        description: 'Casa de praia com 3 quartos',
    ...
    $remainingValue = $booking->checkout(new DateTime('2020-01-10 14:01:00'));

    expect($booking)
        ->isConfirmed()->toBeTrue()
        ->getTotalPrice()->toBe(810.0)
        ->and($remainingValue)->toBe(90.0);
});
